...
class ServiceScaler:
    ...
    def monitor_single_service(self, service_id, cluster_id):
        ...
        try:
            ...
            # Scale Up Logic
            print("up: ", overloaded and current_replicas < scaling_config["max_replicas"])
            print("down: ", not overloaded and current_replicas > initial_replicas)
            if overloaded and current_replicas < scaling_config["max_replicas"]:
                ...
                print("full: ", is_cluster_full(cluster_id))
